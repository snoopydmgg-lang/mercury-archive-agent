...
# 读取完整文案文件
import os
script_file = r"E:\1.work\douyin\1.shuixing\01_Projects_制作中\摄影构图艺术\02_脚本_逻辑链\0416-摄影构图艺术-三套文案.md"
...
# 提取三套文案的口播和画面脚本
# 余上沅的奇妙屋
oral_1_start = content.find("## 口播文案", content.find("## 余上沅的奇妙屋"))
oral_1_end = content.find("---", oral_1_start)
oral_1 = content[oral_1_start+len("## 口播文案"):oral_1_end].strip()

visual_1_start = content.find("## 画面脚本", content.find("## 余上沅的奇妙屋"))
visual_1_end = content.find("---", visual_1_start)
visual_1 = content[visual_1_start+len("## 画面脚本"):visual_1_end].strip()

# 九厘米的雾
oral_2_start = content.find("## 口播文案", content.find("## 九厘米的雾"))
oral_2_end = content.find("---", oral_2_start)
oral_2 = content[oral_2_start+len("## 口播文案"):oral_2_end].strip()

visual_2_start = content.find("## 画面脚本", content.find("## 九厘米的雾"))
visual_2_end = content.find("---", visual_2_start)
visual_2 = content[visual_2_start+len("## 画面脚本"):visual_2_end].strip()

# Ad Scout
oral_3_start = content.find("## 口播文案", content.find("## Ad Scout"))
oral_3_end = content.find("---", oral_3_start)
oral_3 = content[oral_3_start+len("## 口播文案"):oral_3_end].strip()

visual_3_start = content.find("## 画面脚本", content.find("## Ad Scout"))
visual_3_end = content.find("---", visual_3_start)
...
RECORDS = [
    {
        ...
        "BGM\u5efa\u8bae": "Nuvole Bianche - Ludovico Einaudi",
        "\u97f3\u6548\u5efa\u8bae": "\u5feb\u95e8\u58f0\u3001\u89c6\u89c9\u626b\u63cf\u97f3\u6548\u3001\u5206\u5272\u7ebf\u5207\u6362\u97f3\u6548\u3001\u56fe\u8868\u51fa\u73b0\u7684\u53ee\u58f0\u3001\u7bad\u5934\u6ed1\u52a8\u97f3\u6548\u3001\u7ffb\u9875\u97f3\u6548",
        "\u72b6\u6001": "\u5df2\u5b8c\u6210\u6587\u6848",
        "\u53e3\u64ad\u6587\u6848": oral_1,
        "\u753b\u9762\u811a\u672c": visual_1,
    },
    {
        ...
        "BGM\u5efa\u8bae": "The xx - Intro",
        "\u97f3\u6548\u5efa\u8bae": "\u5feb\u901f\u526a\u8f91\u97f3\u6548\u3001\u91d1\u5e01\u6389\u843d\u97f3\u3001\u76f8\u673a\u5feb\u95e8\u58f0\u3001\u5143\u7d20\u7ec4\u5408\u7684\u51e0\u4f55\u97f3\u6548\u3001\u8f6c\u573a\u97f3\u6548\u3001\u7b14\u89e6\u7ed8\u753b\u97f3\u6548\u3001\u601d\u8003\u97f3\u6548\u3001\u8f7b\u5fae\u9875\u9762\u7ffb\u52a8\u97f3",
        "\u72b6\u6001": "\u5df2\u5b8c\u6210\u6587\u6848",
        "\u53e3\u64ad\u6587\u6848": oral_2,
        "\u753b\u9762\u811a\u672c": visual_2,
    },
    {
        ...
        "\u97f3\u6548\u5efa\u8bae": "\u7ffb\u9875\u97f3\u3001\u76f8\u673a\u5feb\u95e8\u58f0\u3001\u653e\u5927/\u7f29\u5c0f\u8fc7\u6e21\u97f3\u6548\u3001\u8f7b\u5fae\u7684\u6068\u7136\u5927\u609f\u97f3\u6548\u3001\u8f7b\u5fae\u7684\u786e\u8ba4\u97f3\u6548\u3001\u8f7b\u5fae\u7684\u786e\u8ba4\u63d0\u793a\u97f3",
        "\u72b6\u6001": "\u5df2\u5b8c\u6210\u6587\u6848",
        "\u53e3\u64ad\u6587\u6848": oral_3,
        "\u753b\u9762\u811a\u672c": visual_3,
    },
...
def main():
    ...
    print("=" * 60)
    print("  Photography - Full Content Upload")
    print("=" * 60)
    print()

    success_count = 0
    for i, record in enumerate(RECORDS, 1):
        print(f"[{i}/3] Uploading...")
